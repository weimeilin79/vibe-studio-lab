...
FILES = {
    ...
    "agent/desk.py": (False, "The desk agents and their long-running tools"),
    "agent/joinlogic.py": (False, "The join condition and result delivery"),
    "agent/drive.py": (False, "answer(): the function_response resume path"),
    "bqgraph/load.py": (False, "The BigQuery property graph DDL"),
    "agent/memory.py": (False, "Memory Bank: create, generate, retrieve"),
}
